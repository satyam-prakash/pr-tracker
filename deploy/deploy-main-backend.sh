#!/bin/bash
# ============================================================
# deploy-main-backend.sh Ã¢â‚¬â€ Independent deployment for Main Backend
# ============================================================
set -e
...
echo "Ã°Å¸Å¡â‚¬ [main-backend] Starting deployment..."
cd $APP_DIR
...
echo "Ã¢Å“â€¦ [main-backend] Deployed successfully at $(date)"
