#!/bin/bash
# ============================================================
# deploy-gateway.sh Ã¢â‚¬â€ Independent deployment for API Gateway
# ============================================================
set -e
...
echo "Ã°Å¸Å¡â‚¬ [gateway] Starting deployment..."
cd $APP_DIR
...
echo "Ã¢Å“â€¦ [gateway] Deployed successfully at $(date)"
